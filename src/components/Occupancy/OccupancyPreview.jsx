                    ...
                    >
                        ...
                        <div style={{ width: '85%' }}>
                            <div style={{ display: 'flex' }}>
                                ...
                                <div style={{ backgroundColor: '#BBBBBB', marginTop: '40px', marginBottom: '30px', height: '50px', width: '100%', display: 'flex', alignItems: 'center', }}>
                                    <h4 style={{ textAlign: 'left', marginLeft: '40px' }}>Occupant Details</h4>
                                </div>
                        ...
                        <div style={{ width: '85%' }}>
                            <div style={{ display: 'flex' }}>
                                ...
                                <div style={{ backgroundColor: '#BBBBBB', marginTop: '40px', marginBottom: '30px', height: '50px', width: '100%', display: 'flex', alignItems: 'center', }}>
                                    <h4 style={{ textAlign: 'left', marginLeft: '40px' }}>Attached Documents</h4>
                                </div>
                        ...
                        <div style={{ marginTop: '50px', marginBottom: '50px', display: 'flex', alignSelf: 'flex-end', marginRight: '150px' }} >
                            <Button
                                ...
                                variant="contained"
                                sx={{ mt: 3, mb: 2, }}
                                onClick={() => navigate('/occupancy_permit')}
                            >
                                Back
                            </Button>
...
export default OccupancyPreview