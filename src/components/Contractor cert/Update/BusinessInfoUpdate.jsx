                        ...
                        <form style={{ width: '70%', marginTop: '50px' }} onSubmit={formik.handleSubmit}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', marginTop: '20px' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', width: '100%', marginLeft: '100px' }}>
                                    <label for="business_name" style={{ marginTop: '30px' }}>Business Name *</label><br />
                                    <input
                                        type="text"
                                        id="businessName"
                                        name="businessName"
                                    ...
                                    {formik.touched.dateOfRegistration && formik.errors.dateOfRegistration && <p style={{ color: 'red', fontSize: '14px', marginTop: "5px" }}>{formik.errors.dateOfRegistration}</p>}
