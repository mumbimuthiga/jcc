            ...
            <Grid container component="main" sx={{ height: '100vh' }}>
                ...
                <Grid item xs={12} sm={8} md={12} component={Paper} elevation={0} square>
                        ...
                        <form style={{ width: '70%' }} onSubmit={handleSubmit}>
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                                ...
                                <Button
                                    ...
                                    variant="contained"
                                    onClick={() => navigate('/accessibility_to_service')}
                                    sx={{ mt: 3, mb: 2, }}
                                >
                                    Next
                                </Button>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', marginTop: '50px', marginBottom: '50px', justifyContent: 'space-around', width: '100%', alignItems: 'center' }}>
                        ...
                        <p onClick={changeStyle2} style={style2}>Building Description</p>
                        <p style={{ cursor: 'pointer', borderBottom: '3px solid #784D0F', }}>Location of Site</p>
